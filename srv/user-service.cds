...
service UserService @(path : '/greenlife') {
    ...
    function getInstructionsByBarcode(barcode : String, locale : String)         returns array of String;
    ...
    function getIDfromCat(subcategory : String)                                  returns array of String;
}
