		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "GreenLife - Admin App",
									"targetURL": "#admingreenlife-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"admingreenlife-display": {
								"semanticObject": "admingreenlife",
								"action": "display",
								"description": "Admin app for GreenLife",
								"title": "GreenLife - Admin App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=admin.greenlife",
									"url": sap.ui.require.toUrl("admin/greenlife")
								}
							}
						}
					}
